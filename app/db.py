"""
Supabase wrapper — plain functions, no ORM. graph.py/tools.py/server.py call
these and never import the supabase client directly, so the storage backend
stays swappable in one file if needed.
